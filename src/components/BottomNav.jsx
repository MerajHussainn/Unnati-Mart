...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-[75px] bg-white/95 backdrop-blur-md flex justify-around items-center z-[1000] border-t border-gray-100 shadow-[0_-4px_30px_rgba(0,0,0,0.06)] px-4 md:max-w-[500px] md:mx-auto md:bottom-8 md:rounded-[2rem] md:border">
      ...
      <a href="#categories" className="flex flex-col items-center gap-1.5 p-2 text-gray-400 font-bold group hover:text-emerald-600 transition-all">
      ...
      <a href="#brands" className="flex flex-col items-center gap-1.5 p-2 text-gray-400 font-bold group hover:text-blue-500 transition-all">
